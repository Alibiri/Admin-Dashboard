        ...
        <div className="overflow-x-auto">
            ...
            <tbody className='"divide-y divide-gray-200'>
                ...
                >
                    ...
                    <td
                        key={field}
                        className={`hidden md:table-cell px-7 py-4 whitespace-nowrap text-sm text-gray-300 
                    ...
                    <td className="hidden md:table-cell px-10 py-4 whitespace-nowrap text-sm text-gray-300">
