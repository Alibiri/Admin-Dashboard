        ...
        <div className="overflow-x-auto">
            ...
            <thead>
                ...
                {["Name", "Email", "Phone Number", "Country", "Actions"].map(
                    ...
                    <th
                        key={header}
                        className="px-3 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider hidden sm:table-cell"
                    >
                        {header}
                    </th>
                    )
            ...
            <tbody className="divide-y divide-gray-700">
                ...
                <motion.tr
                    ...
                    className="block sm:table-row mb-4 sm:mb-0 border-b sm:border-b-0 border-gray-700 sm:border-none p-2 sm:p-0"
                >
                    {/* ✅ Mobile View */}
