...
import { Bell, DollarSign, House, Info, Mail, Settings, ShoppingBag, ShoppingCart, Users, Menu } from "lucide-react"
...
const Sidebar = () => {
    ...
    return (
        <div className={`relative z-10 transition-all duration-300 ease-in-out flex-shrink-0 ${isSidebarOpen ? "W-64" : "w-20"}`}>
            <div className="h-full bg-[#1f1f1f] backdrop-blur-md p-4 flex flex-col border-r border-[#2f2f2f]">
